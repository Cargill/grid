...
use cylinder::Signer;
use grid_sdk::client::organization::{Organization, OrganizationClient};
use grid_sdk::{
...
pub fn do_create_organization(
    client: Box<dyn OrganizationClient>,
...
fn list_organizations(orgs: Vec<Organization>, format: &str, display_alternate_ids: bool) {
    let mut headers = vec![
        "ORG_ID".to_string(),
        "NAME".to_string(),
        "LOCATIONS".to_string(),
...
fn print_organization(org: Organization) {
