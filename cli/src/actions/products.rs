...
use cylinder::Signer;
use grid_sdk::client::product::{GridProduct, GridPropertyValue, ProductClient};
use grid_sdk::client::schema::{DataType, GridPropertyDefinition, SchemaClient};
    ...
    for path in paths {
        ...
        let file_payloads = match file_type {
            ...
            ProductFileType::SchemaBasedDefinition => {
                create_product_payloads_from_yaml(path, &client, service_id)?
            }
        };
...
pub fn update_product_payloads_from_file(
    ...
    for path in paths {
        ...
        let file_payloads = match file_type {
            ...
            ProductFileType::SchemaBasedDefinition => {
                update_product_payloads_from_yaml(path, &client, service_id)?
            }
        };
...
impl ProductCreateYaml {
    pub fn into_payload(
        self,
        definitions: Vec<GridPropertyDefinition>,
