...
const GRID_HOME_ENV: &str = "GRID_HOME";
const GRID_STATE_DIR_ENV: &str = "GRID_STATE_DIR";
const DEFAULT_STATE_DIR: &str = "/var/lib/grid";
const DEFAULT_SQLITE: &str = "grid_state.db";
